...
> Post-publication navigation metadata added by Vault Repair V0.1. This block does not change formal capability conclusions, relationship classifications, Studio-Native Rules, or the historical `_PUBLISHED` snapshot.

- Parent / Navigation: [[Language & Voice QA｜Shared QA Hub]]
- Sources: [[Language & Voice QA｜Capability Charter V0.1]]; [[叶圣陶｜Language & Voice QA 能力蒸馏 V0.1]]; [[汪曾祺｜Language & Voice QA 能力蒸馏 V0.1]]; [[老舍｜Language & Voice QA 能力蒸馏 V0.1]]; [[余光中｜Language & Voice QA 能力蒸馏 V0.1]]; [[刘震云｜Language & Voice QA 能力蒸馏 V0.1]]
- Output: [[Language & Voice QA｜综合能力模型 V0.1]]
