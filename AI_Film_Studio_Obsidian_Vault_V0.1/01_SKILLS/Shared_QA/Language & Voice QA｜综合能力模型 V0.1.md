...
> Post-publication navigation metadata added by Vault Repair V0.1. This block does not change V0.1 capability semantics, Decision Flow, Router, Severity, Safety, or the historical `_PUBLISHED` snapshot.

- Parent / Navigation: [[Language & Voice QA｜Shared QA Hub]]
- Sources: [[Language & Voice QA｜Capability Charter V0.1]]; [[Language & Voice QA｜五人交叉蒸馏 V0.1]]
